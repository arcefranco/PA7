...
export const SidebarData = [
    ...
    options: [
      {
        ...
        rol: "1.2.1",
        cName: "subMenuL2" /* , path:'/operaciones/altaPre' */,
        path: "/onDevelopment",
...

  {
    ...
    options: [
      {
        title: "Vendedores",
        rol: "1.7.1" /* ,path:'/vendedores' */,
        path: "/onDevelopment",
        cName: "subMenuL2",
      },
      {
        title: "Team Leader",
        rol: "1.7.19" /* , path:'/teamleaders' */,
        path: "/onDevelopment",
        cName: "subMenuL2",
      },
      {
        title: "Supervisores",
        rol: "1.7.2" /* , path:'/supervisores' */,
        path: "/onDevelopment",
        cName: "subMenuL2",
      },
      {
        title: "Gerentes",
        rol: "1.7.18" /* , path:'/gerentes' */,
        path: "/onDevelopment",
        cName: "subMenuL2",
      },
      {
        ...
        rol: "1.7.20",
        cName: "subMenuL2" /* , path:'/Estructura' */,
        path: "/onDevelopment",
      },
      {
        title: "Modelos",
        rol: "1.7.6",
        cName: "subMenuL2" /* , path:'/modelos' */,
        path: "/onDevelopment",
      },
      /*       {title: 'Cambio Modelo', rol:'1.7.4', cName:'subMenuL2', path:'/'}, */
      {
        ...
        rol: "1.7.7",
        cName: "subMenuL2" /* , path:'/listasprecios' */,
        path: "/onDevelopment",
      },
      {
        title: "Puntos de Venta",
        rol: "1.7.9",
        cName: "subMenuL2" /* , path:'/puntosDeVenta' */,
        path: "/onDevelopment",
      },
      {
        title: "Sucursales",
        rol: "1.7.3",
        cName: "subMenuL2" /* , path:'/sucursales' */,
        path: "/onDevelopment",
      },
      ...
      {title: 'Objetivos Altas Bajas Mesa de Planes', rol:'1.7.14', cName:'subMenuL2', path:'/'}, */
      {
        title: "Oficiales",
        rol: "1.7.8",
        cName: "subMenuL2" /* , path:'/oficiales' */,
        path: "/onDevelopment",
      },
        ...
        options: [
          ...
          },
          {
            ...
            options: [
              {
                title: "Alta y Modificación de Roles",
                rol: "1.7.16.2" /* , path:'/roles' */,
                path: "/onDevelopment",
                cName: "subMenuL2",
              },
              {
                title: "Copiar Roles",
                rol: "1.7.16.2" /* , path:'/copyRoles' */,
                path: "/onDevelopment",
                cName: "subMenuL2",
              },
            ],
